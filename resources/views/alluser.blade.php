  ...
  <div class="modal-dialog modal-xl" role="document">
      ...
      <div class="modal-content"  style="font-size:10px;">
        <div class="modal-header bg-danger">
          ...
          <div class="btn-group">
            <a href="#" class="btn btn-success btn-sm final_stage_additional_add" data-id="{{$key}}" title="Add New Additional"><span class="fa fa-plus"></span></a> 
            ...
            <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
              <!--
              <a class="dropdown-item" href="/print-final-costing-total/{{$key}}" target="_blank">No Water Mark</a>
              <a class="dropdown-item" href="/print-final-costing-all-figure/{{$key}}" target="_blank">All in Figure</a>
              <a class="dropdown-item" href="/print-final-costing-no-extra/{{$key}}" target="_blank">No Extra</a>
