...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="/hatchback/{{$key}}">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span><b>Hatchback Exterior<b></span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/hatchbackinterior/{{$key}}">
          <i class="fas fa-fw fa-tachometer-alt"></i>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item double_cab_bumper" href="/hatchbackfrontbumper/{{$key}}">Bumper</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/hatchbackfrontdoor/{{$key}}">Front Door</a>
            <a class="collapse-item" href="/hatchbackreardoor/{{$key}}">Rear Door</a>
            <a class="collapse-item" href="/hatchbackfrontsuspension/{{$key}}">Front Suspension</a>
            <a class="collapse-item" href="/hatchbackrearsuspension/{{$key}}">Rear Suspension</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBakkie" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/hatchbackrearbumper/{{$key}}">Rear Bumper</a>
          </div>
        </div>
      </li>  
      ...
      <li class="nav-item">
        ...
        <div id="collapseInnerFront" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/hatchbackEngine/{{$key}}">Engine</a>
            <a class="collapse-item" href="/hatchbackTransmission/{{$key}}">Transmission</a>
            <a class="collapse-item" href="/hatchbackair/{{$key}}">Air Conditioner</a>
            <a class="collapse-item" href="/hatchbackDashboard/{{$key}}">Dashboard</a>
          </div>
        </div>
      </li> 
      <!--End Nav-->
      ...
      <li class="nav-item">
        ...
        <div id="collapseInnerSide" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/hatchbackfrontseat/{{$key}}">Front Seat</a>
            <a class="collapse-item" href="/hatchbackrearseat/{{$key}}">Rear Seat</a>
       ...
       <li class="nav-item">
        ...
        <div id="collapseInnerRear" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/hatchbacExhaust/{{$key}}">Exhaust</a>
            <a class="collapse-item" href="/hatchbacFuel/{{$key}}">Fuel System</a>
          </div>
        </div>
      </li> 
      <!--End Nav-->
                   ...
                   <!--
                           ...
                           <!-- Collapsable Card Quote -->
                                ...
                                <!-- Card Content - Collapse -->
                                            ...
                                            <button class="btn btn-primary editQuote btn-sm" data-id="{{$quote_infos->id}}" data-oper="{{$quote_infos->Oper}}" data-desc="{{$quote_infos->Description}}" data-markup="{{$quote_infos->MarkUp}}" data-bett="{{$quote_infos->Betterment}}" data-qty="{{$quote_infos->Quantity}}" data-part="{{$quote_infos->Part}}" data-labour="{{$quote_infos->Labour}}" data-paint="{{$quote_infos->Paint}}" data-strip="{{$quote_infos->Strip}}" data-frame="{{$quote_infos->Frame}}" data-outwork="{{$quote_infos->Misc}}">
