  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="font-size:10px;">
      ...
      <hr class="sidebar-divider">
        ...
        <!-- Nav Item -  Body Side Menu -->
        <li class="nav-item">
        <a class="nav-link" href="/openQuotation/{{$key}}" >
      ...
      <hr class="sidebar-divider">
        <li class="nav-item">
          <a class="nav-link" href="/print-prebooking/{{$key}}" target="_blank">
      ...
      <hr class="sidebar-divider">
        ...
        <!-- Nav Item -  Body Side Menu -->
        <li class="nav-item">
        <a class="nav-link" href="/client-document/{{$key}}" >
      ...
      <!-- Nav Item -  Body Side Menu -->
      <li class="nav-item">
        <a class="nav-link" href="/client-security-photos/{{$key}}" >
      ...
      <!-- Nav Item -  Body Side Menu -->
      <li class="nav-item">
        <a class="nav-link" href="/client-notes/{{$key}}" >
      ...
      <!-- Nav Item -  Body Side Menu -->
      <li class="nav-item">
        <a class="nav-link" href="/client-rate/{{$key}}" >
      ...
      <!-- Nav Item -  Body Side Menu -->
      <li class="nav-item">
        <a class="nav-link" href="/view-proforma/{{$key}}" >
      ...
      <!-- Nav Item -  Body Side Menu -->
      <li class="nav-item">
        <a class="nav-link" href="/wip-sms/{{$key}}" >
