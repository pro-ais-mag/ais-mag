...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- End of Sidebar -->
    <ul style="position:fixed;margin-left:950px;background-color:#f1f1f1;">
<div>
    <button title="NEW" class="show-modal btn btn-secondary new btn-sm" data-oper="New" style="margin-top:5px;">N</button>
                   ...
                   <!--
                           ...
                           <!-- Collapsable Card Quote -->
                                ...
                                <!-- Card Content - Collapse -->
                                            ...
                                            <table class="table table-bordered" style="font-size:12px;" id="quoteData" width="80%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                <th>Oper</th>
                                                <th>Description</th>
