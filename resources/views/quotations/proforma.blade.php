...
<div class="card shadow mb-4">
            <div class="card-header py-3">
                <h4 class="m-0 font-weight-bold text-primary">Proforma Invoice - {{$key}}</h4>
                <a class="btn btn-warning float-right btn-sm storage-modal" data-id="{{$key}}" href="#">Storage Rates</a>
                <div class="form-group col-md-2 float-right">
                  <div>
                  @foreach($proforma as $proform)
                  @if($proform->writeoff==1)
                    <div class="form-check">
                      <input class="form-check-input write_off" data-id="{{$key}}" type="checkbox" id="write_off" name="write_off" checked>
                  ...
                  @else
                  <div class="form-check">
                      <input class="form-check-input write_off" data-id="{{$key}}" type="checkbox" id="write_off" name="write_off">
                      <label class="form-check-label" for="write_off">
                        Write Off
                      </label>
                    </div>
                ...
                <div class="row">
                    <div class="card-sm shadow mb-1 col-4">
                            ...
                            {{ csrf_field() }}
                                ...
                                <div class="card-body">
                                <input type="hidden" name="proforma_id" id="proforma_id" value="{{$key}}">
                                <!--Storage Days-->
