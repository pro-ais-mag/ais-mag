...
<div class="card shadow mb-4">
            <div class="card-header py-3">
                <h4 class="m-0 font-weight-bold text-primary">Quotation Details - {{$key}}</h4>
<br>
            ...
            <div class="card-body">
                                ...
                                @foreach($client_details as $client)
                                    <tr>
                                       ...
                                       <!--<a class="btn btn-primary" title="Double Cab" data-id="{{$client->Key_Ref}}" data-vehicle="double" href="/exterior/{{$client->Key_Ref}}">
                                        ...
                                        <!--<a class="btn-sm btn-success show-modal" title="Graphics" data-id="{{$client->Key_Ref}}" href="#">Graphics</a>
                                        </div></td>-->
                                    </tr>
                                @endforeach
                  </tbody>
                ...
                <table class="table-sm table-dark" id="workin" style="font-size:10px;width:100%;"name="workin">
                      ...
                      <td ><input type="text" class="form-control form-control-sm" name="EditDesc_{{$quote_infos->id}}" id="EditDesc_{{$quote_infos->id}}" value="{{$quote_infos->Description}}" style="width:120px;margin-bottom:2px;font-size:10px;"></td>
                      <td><input type="text" class="form-control form-control-sm" name="EditMark_{{$quote_infos->id}}" id="EditMark_{{$quote_infos->id}}" value="{{$quote_infos->Percent}}" style="width:50px;margin-bottom:2px;font-size:10px;"></td>
                      <td><input type="text" class="form-control form-control-sm" name="EditBett_{{$quote_infos->id}}" id="EditBett_{{$quote_infos->id}}" value="{{$quote_infos->Betterment}}" style="width:50px;margin-bottom:2px;font-size:10px;"></td>
                      <td><input type="text" class="form-control form-control-sm" name="EditQty_{{$quote_infos->id}}" id="EditQty_{{$quote_infos->id}}" value="{{$quote_infos->Quantity}}" style="width:50px;margin-bottom:2px;font-size:10px;"></td>
                      <td><input type="text" class="form-control form-control-sm" name="EditPart_{{$quote_infos->id}}" id="EditPart_{{$quote_infos->id}}" value="{{$quote_infos->Part}}" style="width:70px;margin-bottom:2px;font-size:10px;"></td>

                      <td><input type="text" class="form-control form-control-sm" name="labourEdit_{{$quote_infos->id}}" id="labourEdit_{{$quote_infos->id}}" value="{{ number_format($quote_infos->Labour * $quote_infos->ins_labour,2 ) }}" style="width:50px;margin-bottom:2px;font-size:10px;"></td>

                      <td><input type="text" class="form-control form-control-sm" name="paintEdit_{{$quote_infos->id}}" id="paintEdit_{{$quote_infos->id}}" value="{{number_format($quote_infos->Paint * $quote_infos->ins_paint,2)}}" style="width:50px;margin-bottom:2px;font-size:10px;"></td>  

                      <td><input type="text" class="form-control form-control-sm" name="stripEdit_{{$quote_infos->id}}" id="stripEdit_{{$quote_infos->id}}" value="{{number_format($quote_infos->Strip * $quote_infos->ins_strip,2)}}" style="width:50px;margin-bottom:2px;font-size:10px;"></td>

                      <td><input type="text" class="form-control form-control-sm" name="frameEdit_{{$quote_infos->id}}" id="frameEdit_{{$quote_infos->id}}" value="{{number_format($quote_infos->Frame * $quote_infos->ins_frame,2)}}" style="width:50px;margin-bottom:2px;font-size:10px;"></td>

                      <td><input type="text" class="form-control form-control-sm" name="outworkEdit_{{$quote_infos->id}}" id="outworkEdit_{{$quote_infos->id}}" value="{{number_format($quote_infos->Misc,2)}}" style="width:50px;margin-bottom:2px;font-size:10px;"></td>

                                              
                                    <td>
                                        <div class="btn-group">
                                        <a href="#" title="Edit" class="btn btn-primary btn-sm editMoneyQuote"  id="{{$quote_infos->id}}">
                                          <span class="fa fa-edit"></span></a>
                                        <a href="#" title="Delete" class="btn btn-sm btn-danger deleteQuote" style="margin-left:5px;" data-id="{{$quote_infos->id}}" data-description="{{$quote_infos->Description}}"><span class="fa fa-trash"></span></a>
                                        </div>
                                ...
                                <td>{{$quote_infos->Oper}}</td>
                                                ...
                                                <td>{{number_format($quote_infos->Labour * $quote_infos->ins_labour,2 ) }} </td>
                                                <td>{{number_format($quote_infos->Paint * $quote_infos->ins_paint,2)}}</td>  
                                                <td>{{number_format($quote_infos->Strip * $quote_infos->ins_strip,2)}}</td>
                                                <td>{{number_format($quote_infos->Frame * $quote_infos->ins_frame,2)}}</td>
                                                <td>{{number_format($quote_infos->Misc,2)}}</td>
                                    <td>
                                        <a href="#" title="Edit" class="btn-sm btn-primary  editQuoteMoney" data-id="{{$quote_infos->id}}" data-oper="{{$quote_infos->Oper}}" data-desc="{{$quote_infos->Description}}" data-markup="{{$quote_infos->MarkUp}}" data-bett="{{number_format($quote_infos->Betterment,2)}}" data-qty="{{number_format($quote_infos->Quantity,2)}}" data-part="{{number_format($quote_infos->Part,2)}}" data-labour="{{number_format($quote_infos->Labour*$quote_infos->ins_labour,2)}}" data-paint="{{number_format($quote_infos->Paint*$quote_infos->ins_paint,2)}}" data-strip="{{number_format($quote_infos->Strip*$quote_infos->ins_strip,2)}}" data-frame="{{number_format($quote_infos->Frame*$quote_infos->ins_frame,2)}}" data-outwork="{{number_format($quote_infos->Misc,2)}}" data-ref="{{$quote_infos->Key_Ref}}"><span class="fa fa-edit"></span></a>
                                        <a href="/deleteQuote/{{$quote_infos->id}}" title="Delete" class="btn-sm btn-danger"><span class="fa fa-trash"></span></a>
                                    </td>
                                </tr>
                               END HERE # -->
