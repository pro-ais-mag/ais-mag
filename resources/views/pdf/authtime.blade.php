...
<body>
    ...
    <img src="img/letter_head.png">
        <p style="text-align:center;font-size:8"><b>AUTHORIZED QUOTE</b><br> <span style="font-size:7">Date: {{date('Y-m-d')}}</span></p>
                    ...
                    <td style="width:150">
                        <table>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right;width:60;"><b>R {{number_format(($labour_total*$laborRate)+($paint_total*$paintRate)+($strip_total*$stripRate)+($frame_total*$frameRate)+($parts*($shopSupply/100))+$outwork_total+($paint_total*$paintRate*($paintSupply/100))+$parts,2)}}</b></td>
                            </tr>
                            <tr>
