...
<td style="width:185px;">:{{$comp_tel}}</td>
</tr>
...
<td style="border: 1px solid black;">{{$Claim_NO}}</td>
<td style="border: 1px solid black;">{{$Inserer}}</td>
</tr>
</table><br><br>
...
<tr>
<td style="height:250px;border: 1px solid black;">{{$inv_desc}}</td>
<td style="border: 1px solid black;">1</td>
<td style="border: 1px solid black;">R{{number_format($inv_amount,2)}}</td>
<td style="border: 1px solid black;">R{{number_format($inv_amount,2)}}</td>
</tr>
...
<td style="border: 1px solid black;">R{{number_format($inv_amount*15/100,2)}}</td>
</tr>

<tr>
<td style="border: 1px solid black;">Discount@ {{$inv_discount}}%</td>
<td style="border: 1px solid black;">R{{number_format($inv_amount*$inv_discount/100,2)}}</td>
</tr>

<tr>
<td style="border: 1px solid black;">TOTAL</td>
<td style="border: 1px solid black;">R{{number_format((($inv_amount + $inv_amount*15/100)-$inv_amount*$inv_discount/100),2)}}</td>
</tr>
</table><br>
