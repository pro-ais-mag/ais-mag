...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="/exterior/{{$key}}">
      ...
      <!--Go Back To Quote-->
      <li class="nav-item">
        <a class="nav-link" href="/viewQuotation/{{$key}}">
          <i class="fas fa-fw fa-tachometer-alt"></i>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item double_cab_bumper" href="/doublecabfrontbumper/{{$key}}">Bumper</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/doublecabdoor/{{$key}}">Front Door</a>
            <a class="collapse-item" href="/doublecabreardoor/{{$key}}">Rear Door</a>
            <a class="collapse-item" href="/doublecabfrontsuspension/{{$key}}">Front Suspension</a>
            <a class="collapse-item" href="/doublecabrearsuspension/{{$key}}">Rear Suspension</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBakkie" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/doublecabrearbumper/{{$key}}">Rear Bumper</a>
          </div>
        </div>
      </li>  
      ...
      <li class="nav-item">
        ...
        <div id="collapseInnerFront" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/doublecabengine/{{$key}}">Engine</a>
            <a class="collapse-item" href="/doublecabtranmission/{{$key}}">Transmission</a>
            <a class="collapse-item" href="/doublecabAirConditioner/{{$key}}">Air Conditioner</a>
            <a class="collapse-item" href="/doublecabDashboard/{{$key}}">Dashboard</a>
          </div>
        </div>
      </li> 
      <!--End Nav-->
      ...
      <li class="nav-item">
        ...
        <div id="collapseInnerSide" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/doublecabFrontSeat/{{$key}}">Front Seat</a>
            <a class="collapse-item" href="/doublecabRearSeat/{{$key}}">Rear Seat</a>
       ...
       <li class="nav-item">
        ...
        <div id="collapseInnerRear" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/doublecabExhaust/{{$key}}">Exhaust</a>
            <a class="collapse-item" href="/doublecabFuel/{{$key}}">Fuel System</a>
          </div>
        </div>
      </li> 
      <!--End Nav-->
                   ...
                   <!--
                           ...
                           <!-- Collapsable Card Quote -->
                                ...
                                <!-- Card Content - Collapse -->
                                            ...
                                            <button class="btn btn-primary editQuote btn-sm" data-id="{{$quote_infos->id}}" data-oper="{{$quote_infos->Oper}}" data-desc="{{$quote_infos->Description}}" data-markup="{{$quote_infos->MarkUp}}" data-bett="{{number_format($quote_infos->Betterment,2)}}" data-qty="{{number_format($quote_infos->Quantity,2)}}" data-part="{{number_format($quote_infos->Part,2)}}" data-labour="{{number_format($quote_infos->Labour,2)}}" data-paint="{{number_format($quote_infos->Paint,2)}}" data-strip="{{number_format($quote_infos->Strip,2)}}" data-frame="{{number_format($quote_infos->Frame,2)}}" data-outwork="{{number_format($quote_infos->Misc,2)}}">
                                                <span class="fa fa-edit"></span></button>    
                                                
                                                <a class=" btn btn-danger btn-sm" href="/deleteQuote/{{$quote_infos->id}}" style="margin-left:5px;" data-id="{{$quote_infos->id}}" data-oper="{{$quote_infos->Oper}}" data-desc="{{$quote_infos->Description}}" data-markup="{{$quote_infos->MarkUp}}" data-bett="{{$quote_infos->Betterment}}" data-qty="{{$quote_infos->Quantity}}" data-part="{{$quote_infos->Part}}" data-labour="{{$quote_infos->Labour}}" data-paint="{{$quote_infos->Paint}}" data-strip="{{$quote_infos->Strip}}" data-frame="{{$quote_infos->Frame}}" data-outwork="{{$quote_infos->Misc}}">
