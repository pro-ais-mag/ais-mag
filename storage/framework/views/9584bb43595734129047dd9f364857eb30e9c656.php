...
<head>
    ...
    <title>Authorized Quote Print</title>
</head>
<body>
                    ...
                    <td style="width:150">
                        <table>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right;width:60;"><b>R <?php echo e(number_format(($labour_total*$laborRate)+($paint_total*$paintRate)+($strip_total*$stripRate)+($frame_total*$frameRate)+($parts*($shopSupply/100))+$outwork_total+($paint_total*$paintRate*($paintSupply/100))+$parts,2)); ?></b></td>
                            </tr>
                            <tr>
