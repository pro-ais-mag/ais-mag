...
<div class="card-header py-1">
                ...
                <input type="hidden" name="track" id="track" value="<?php echo e($key); ?>">
</div>
...
<div class="row">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
      ...
      <a class="dropdown-item" href="/print-release-payment/<?php echo e($client->Key_Ref); ?>" target="_blank">Pay Receipt</a>
      <a class="dropdown-item" href="/print-clearance-certificate/<?php echo e($client->Key_Ref); ?>" target="_blank">MAG Clearance</a>
      <a class="dropdown-item" href="/print-taxi-clearance/<?php echo e($client->Key_Ref); ?>" target="_blank">S.A Taxi Clearance</a>
      <a class="dropdown-item" href="/print-old-mutual/<?php echo e($client->Key_Ref); ?>" target="_blank">Omnisure Clearance</a>
      <a class="dropdown-item" href="/print-client-note/<?php echo e($client->Key_Ref); ?>" target="_blank">Notes</a>
...
<div class="row" style="margin-bottom:10px;">
  ...
  <button type="button" class="btn btn-dark btn-sm dropdown-toggle" id="dropdownMenuOffset" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="margin-left:5px;">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuOffset">
      <a class="dropdown-item final_photos" data-id="<?php echo e($client->Key_Ref); ?>" data-category="SECURITY"  href="#">Security Photos  [ <?php echo e($security_photo_count); ?> ]</a>
      <a class="dropdown-item final_photos" data-id="<?php echo e($client->Key_Ref); ?>" data-category="FINAL STAGE" href="#">Final Photos [ <?php echo e($final_photo_count); ?> ]</a>
    <a class="dropdown-item final_photos" data-id="<?php echo e($client->Key_Ref); ?>" data-category="ADDITIONAL" href="#">Additional Photos  [ <?php echo e($additional_photo_count); ?> ]</a>
    <a class="dropdown-item final_photos" data-id="<?php echo e($client->Key_Ref); ?>" data-category="WORK IN PROGRESS" href="#">WIP Photos [ <?php echo e($wip_photo_count); ?> ]</a>
  ...
  <a href="#" class="btn btn-dark btn-sm final_ordering" data-id="<?php echo e($client->Key_Ref); ?>" style="margin-left:10px;">Ordering</a>
  <a href="#" class="btn btn-dark btn-sm final_rate" data-id="<?php echo e($client->Key_Ref); ?>" style="margin-left:10px;">Rates</a>
  ...
  <div class="dropdown mr-1">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuShortcuts">
        <a class="dropdown-item" href="/customer-care-client-details/<?php echo e($client->Key_Ref); ?>">Invoice Client</a>
        <a class="dropdown-item" href="/view-precosting/<?php echo e($client->Key_Ref); ?>" >Ordering Parts</a>
        <a class="dropdown-item" href="/assessor" >Assessor</a>
        <a class="dropdown-item" href="/viewQuotation/<?php echo e($client->Key_Ref); ?>">Approved Quote</a>
    </div> 
    ...
    <div class="input-group sm" id="dob_span">
     <div class="input-group-prepend">
      <span class="input-group-text sm" id="basic-addon1" style="height:25px;font-size:10px;">Client</span>
       ...
       <input type="text" name="name_last" id="name_last" class="form-control form-control-sm font-sm"  aria-describedby="basic-addon1" value="<?php echo e($client->Fisrt_Name); ?> <?php echo e($client->Last_Name); ?>" style="font-size:10px;width:250px;">
     </div>
    </div>
...
<div class="input-group sm" id="dob_span">
    ...
    <div class="input-group sm" id="dob_span">
     ...
     <input type="date" name="final_date" id="final_date" style="font-size:10px;" value="<?php echo e($client->Date); ?>" class="form-control form-control-sm font-sm"  aria-describedby="basic-addon1">

      <!--
      <input type="date" name="final_date" id="final_date" style="font-size:10px;" default value="<?php echo e($client->Date); ?>" onload="date_value()" class="form-control form-control-sm font-sm"  aria-describedby="basic-addon1">
      -->
     </div>
    </div>                        
    <!--End-->
    <?php $dates=$client->Date;?>
</div>
<!--End of-->
