        ...
        <td>
            <table style="font-size:8;">
                <tr>
                    ...
                    <td style="width:150;">: <?php echo e($name); ?></td>
                    <td style="width:100;"><b>Reg No.</b></td>
                    <td style="width:150;">: <?php echo e($reg); ?></td>
                </tr>
                <tr>
                    <td style="width:100;"><b>Vehicle</b></td>
                    <td style="width:150;">: <?php echo e($model); ?></td>
                    <td style="width:100;"><b>Odometer</b></td>
                    <td style="width:150;">: <?php echo e($kms); ?></td>
                </tr>
                <tr>
                    <td style="width:100;"><b>Chassis</b></td>
                    <td style="width:150;">: <?php echo e($chassis); ?></td>
                    <td style="width:100;"><b>Insurer</b></td>
                    <td style="width:150;">: <?php echo e($insurer); ?></td>
                </tr>
                <tr>
                    <td style="width:100;"><b>Date</b></td>
                    <td style="width:150;">: <?php echo e($ro); ?></td>
...
<h3 style="font-size:12;text-align:center;"><b>Track Number: <?php echo e($ref); ?></b></h3><br>
<hr>
        <div class="row">
        <div class="column">
        ...
        <div class="column">
            <table border="0" style="font-size:10px;margin-left:25px;width:100%;border:solid black 1px;">          
                ...
                <tr style="background-color:green;color:#fff;">
                    ...
                    <td colspan="2" style="text-align:right;border-style:none"><b style="color:#fff;font-size:8px;"><?php echo e($ttlStrip); ?> Hours</b></td>
                </tr>                
                <tr style="height:8px;">
                ...
                <tr style="background-color:green;color:#fff;">
                    ...
                    <td colspan="2" style="text-align:right;border-style:none;"><b style="color:#fff;font-size:10;"><?php echo e($ttlLabor); ?> Hours</b></td>
                </tr>
                <tr>
                ...
                <tr style="background-color:green;color:#fff;">
                    ...
                    <td colspan="2" style="text-align:right;border-style:none;"><b style="color:#fff;font-size:8px;"><?php echo e($ttlPaint); ?> Hours</b></td>
                </tr>
                <tr>
