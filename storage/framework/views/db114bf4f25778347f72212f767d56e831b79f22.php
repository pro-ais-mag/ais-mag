...
<br>
            ...
            <div class="card-body">
                    ...
                    <table class="table-sm table-bordered table-dark" style="font-size:10px;">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <select id="opa" name="opa" class="form-control form-control-sm" style="font-size:10px;">
                          ...
                          <td><input type="text" name="desc" id="desc" class="form-control form-control-sm" style="font-size:10px;"></td>
                          <div id="part_desc" name="part_desc"></div>
                          <td><input type="text" name="mark" id="mark" style="width:50px;font-size:10px;" class="form-control"></td>
                          <td><input type="text" name="bett" id="bett"  style="width:50px;font-size:10px;" class="form-control"></td>
                          <td><input type="text" name="qty" id="qty" style="width:50px;font-size:10px;" class="form-control"></td>
                          <td><input type="text" name="part" id="part" style="width:100px;font-size:10px;" class="form-control"></td>
                          <td><input type="text" name="labor" id="labor" style="width:50px;font-size:10px;" class="form-control"></td>
                          <td><input type="text" name="paint" id="paint" style="width:50px;font-size:10px;" class="form-control"></td>
                          <td><input type="text" name="strip" id="strip" style="width:50px;font-size:10px;" class="form-control"></td>
                          <td><input type="text" name="frame" id="frame" style="width:50px;font-size:10px;" class="form-control"></td>
                          <td><input type="text" name="outwork" id="outwork" style="width:50px;font-size:10px;" class="form-control"></td>
                ...
                <table class="table-sm table-dark" id="workin" style="font-size:10px;width:100%;"name="workin">
                      ...
                      <td ><input type="text" class="form-control form-control-sm" name="EditDesc_<?php echo e($quote_infos->id); ?>" id="EditDesc_<?php echo e($quote_infos->id); ?>" value="<?php echo e($quote_infos->Description); ?>" style="width:120px;margin-bottom:2px;font-size:10px;"></td>
                      <td><input type="text" class="form-control form-control-sm" name="EditMark_<?php echo e($quote_infos->id); ?>" id="EditMark_<?php echo e($quote_infos->id); ?>" value="<?php echo e($quote_infos->Percent); ?>" style="width:50px;margin-bottom:2px;font-size:10px;"></td>
                      <td><input type="text" class="form-control form-control-sm" name="EditBett_<?php echo e($quote_infos->id); ?>" id="EditBett_<?php echo e($quote_infos->id); ?>" value="<?php echo e($quote_infos->Betterment); ?>" style="width:50px;margin-bottom:2px;font-size:10px;"></td>
                      <td><input type="text" class="form-control form-control-sm" name="EditQty_<?php echo e($quote_infos->id); ?>" id="EditQty_<?php echo e($quote_infos->id); ?>" value="<?php echo e($quote_infos->Quantity); ?>" style="width:50px;margin-bottom:2px;font-size:10px;"></td>
                      <td><input type="text" class="form-control form-control-sm" name="EditPart_<?php echo e($quote_infos->id); ?>" id="EditPart_<?php echo e($quote_infos->id); ?>" value="<?php echo e($quote_infos->Part); ?>" style="width:70px;margin-bottom:2px;font-size:10px;"></td>

                      <td><input type="text" class="form-control form-control-sm" name="labourEdit_<?php echo e($quote_infos->id); ?>" id="labourEdit_<?php echo e($quote_infos->id); ?>" value="<?php echo e(number_format($quote_infos->Labour * $quote_infos->ins_labour,2 )); ?>" style="width:50px;margin-bottom:2px;font-size:10px;"></td>

                      <td><input type="text" class="form-control form-control-sm" name="paintEdit_<?php echo e($quote_infos->id); ?>" id="paintEdit_<?php echo e($quote_infos->id); ?>" value="<?php echo e(number_format($quote_infos->Paint * $quote_infos->ins_paint,2)); ?>" style="width:50px;margin-bottom:2px;font-size:10px;"></td>  

                      <td><input type="text" class="form-control form-control-sm" name="stripEdit_<?php echo e($quote_infos->id); ?>" id="stripEdit_<?php echo e($quote_infos->id); ?>" value="<?php echo e(number_format($quote_infos->Strip * $quote_infos->ins_strip,2)); ?>" style="width:50px;margin-bottom:2px;font-size:10px;"></td>

                      <td><input type="text" class="form-control form-control-sm" name="frameEdit_<?php echo e($quote_infos->id); ?>" id="frameEdit_<?php echo e($quote_infos->id); ?>" value="<?php echo e(number_format($quote_infos->Frame * $quote_infos->ins_frame,2)); ?>" style="width:50px;margin-bottom:2px;font-size:10px;"></td>

                      <td><input type="text" class="form-control form-control-sm" name="outworkEdit_<?php echo e($quote_infos->id); ?>" id="outworkEdit_<?php echo e($quote_infos->id); ?>" value="<?php echo e(number_format($quote_infos->Misc,2)); ?>" style="width:50px;margin-bottom:2px;font-size:10px;"></td>

                                              
                                    <td>
                                        <div class="btn-group">
                                        <a href="#" title="Edit" class="btn btn-primary btn-sm editMoneyQuote"  id="<?php echo e($quote_infos->id); ?>">
                                          <span class="fa fa-edit"></span></a>
                                        <a href="#" title="Delete" class="btn btn-sm btn-danger deleteQuote" style="margin-left:5px;" data-id="<?php echo e($quote_infos->id); ?>" data-description="<?php echo e($quote_infos->Description); ?>"><span class="fa fa-trash"></span></a>
                                        </div>
                                ...
                                <td><?php echo e($quote_infos->Oper); ?></td>
                                    ...
                                    <td>
                                        <a href="#" title="Edit" class="btn-sm btn-primary  editQuoteMoney" data-id="<?php echo e($quote_infos->id); ?>" data-oper="<?php echo e($quote_infos->Oper); ?>" data-desc="<?php echo e($quote_infos->Description); ?>" data-markup="<?php echo e($quote_infos->MarkUp); ?>" data-bett="<?php echo e(number_format($quote_infos->Betterment,2)); ?>" data-qty="<?php echo e(number_format($quote_infos->Quantity,2)); ?>" data-part="<?php echo e(number_format($quote_infos->Part,2)); ?>" data-labour="<?php echo e(number_format($quote_infos->Labour*$quote_infos->ins_labour,2)); ?>" data-paint="<?php echo e(number_format($quote_infos->Paint*$quote_infos->ins_paint,2)); ?>" data-strip="<?php echo e(number_format($quote_infos->Strip*$quote_infos->ins_strip,2)); ?>" data-frame="<?php echo e(number_format($quote_infos->Frame*$quote_infos->ins_frame,2)); ?>" data-outwork="<?php echo e(number_format($quote_infos->Misc,2)); ?>" data-ref="<?php echo e($quote_infos->Key_Ref); ?>"><span class="fa fa-edit"></span></a>
