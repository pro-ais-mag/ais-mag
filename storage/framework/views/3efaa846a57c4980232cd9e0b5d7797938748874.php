    ...
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content"  style="font-size:10px;">
        <div class="modal-header bg-danger">
          ...
          <div class="btn-group">
          <button class="btn btn-secondary btn-sm" type="button" data-dismiss="modal">Cancel</button>
            <a href="#" style="margin-left:5px;" class="btn btn-success btn-sm final_stage_additional_add" data-id="<?php echo e($key); ?>" title="Add New Additional"><span class="fa fa-plus"></span></a> 
