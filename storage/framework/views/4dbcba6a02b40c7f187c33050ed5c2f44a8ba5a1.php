                            ...
                            <div class="col-4">
                                <table>
                                  ...
                                  <tbody>  
                                    ...
                                    <tr>
                                        <td><a href="#" class="btn btn-primary send_sms text-sm btn-sm" style="margin-bottom:5px;" data-title="<?php echo e($tow->title); ?>" data-message="<?php echo e($tow->message); ?>" data-id="<?php echo e($key); ?>" data-mid="<?php echo e($tow->stage_no); ?>" data-reg="<?php echo e($reg); ?>" data-cell_no="<?php echo e($cell_no); ?>"><?php echo e($tow->title); ?></a></td>
                                        <td><a href="#" class="btn btn-warning send_sms btn-sm" data-title="<?php echo e($tow->title); ?>" style="margin-bottom:5px;" data-message="<?php echo e($tow->message); ?>" data-id="<?php echo e($key); ?>"><span class="fa fa-edit"></span></a></td>    
                                    </tr>
                        ...
                        <div class="row">
                            ...
                            <table>
                                  ...
                                  <tbody>  
                                    ...
                                    <tr>
                                        <td><a href="#" class="btn btn-primary send_sms text-sm btn-sm" style="margin-bottom:5px;" data-title="<?php echo e($tow->title); ?>" data-message="<?php echo e($tow->message); ?>" data-id="<?php echo e($key); ?>" data-mid="<?php echo e($tow->stage_no); ?>" data-reg="<?php echo e($reg); ?>" data-cell_no="<?php echo e($cell_no); ?>"><?php echo e($tow->title); ?></a></td>
                                        <td><a href="#" class="btn btn-warning send_sms btn-sm" style="margin-bottom:5px;" data-title="<?php echo e($tow->title); ?>" data-message="<?php echo e($tow->message); ?>" data-id="<?php echo e($key); ?>"><span class="fa fa-edit"></span></a></td>    
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                  </tbody>  
                            </table>
