...
<div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <a href="/print-consumables/<?php echo e($key); ?>" class="btn btn-danger float-right btn-sm" title="Print Consumerables" target="_blank" style="margin-left:5px;"><span class="fa fa-tags"></span></a>
                <a href="/print-time-sheet/<?php echo e($key); ?>" class="btn btn-secondary float-right btn-sm" title="Print Time Sheet" target='_blank'  style="margin-left:5px;"><span class="fa fa-print"></span></a>
                <a href="/print-itemized/<?php echo e($key); ?>" class="btn btn-warning float-right btn-sm" title="Print Intemized LIst" target="_blank"><span class="fa fa-shopping-cart"></span></a>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-10">
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade show" id="list-security-photos" role="tabpanel" aria-labelledby="list-home-list">
                                        ...
                                        <div class="row">
                                            <div>
                                            <form action="/line-manager-security-upload" class="form-control-sm form-control-file" method="POST" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                                                    <a class="thumbnail fancybox" rel="ligthbox" href="/images/mag_security/<?php echo e($image->Key_Ref); ?>/<?php echo e($image->url); ?>" target=z>
                                                        <img class="img-fluid img-thumbnail" alt="" src="/images/mag_security/<?php echo e($image->Key_Ref); ?>/<?php echo e($image->url); ?>">
                                        ...
                                        <?php echo e(csrf_field()); ?> 
                                            ...
                                            <tbody>
                                                ...
                                                <td>
                                                    ...
                                                    <td><input type="text" name="mark" id="mark" style="width:50px;font-size:12px;" class="form-control form-control-sm"></td>
                                                    <td><input type="text" name="bett" id="bett"  style="width:50px;font-size:12px;" class="form-control form-control-sm"></td>
                                                    <td><input type="text" name="qty" id="qty" style="width:50px;font-size:12px;" class="form-control form-control-sm"></td>
                                                    <td><input type="text" name="part" id="part" style="width:50px;font-size:12px;" class="form-control form-control-sm"></td>
                                                    <td><input type="text" name="labor" id="labor" style="width:50px;font-size:12px;" class="form-control form-control-sm"></td>
                                                    <td><input type="text" name="paint" id="paint" style="width:50px;font-size:12px;" class="form-control form-control-sm"></td>
                                                    <td><input type="text" name="strip" id="strip" style="width:50px;font-size:12px;" class="form-control form-control-sm"></td>
                                                    <td><input type="text" name="frame" id="frame" style="width:50px;font-size:12px;" class="form-control form-control-sm"></td>
                                                    <td><input type="text" name="outwork" id="outwork" style="width:50px;font-size:12px;" class="form-control form-control-sm"></td>
