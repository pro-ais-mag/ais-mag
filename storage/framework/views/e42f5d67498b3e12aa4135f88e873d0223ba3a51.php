      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <!--<a class="collapse-item" href="/create-quote">Create New Entry</a>-->
            <a class="collapse-item" href="/openQuotation/<?php echo e($key); ?>">Edit Entry</a>
            <a class="collapse-item" href="/create-quote">New Entry</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseQuickPrint" class="collapse" aria-labelledby="headingQuickPrint" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/viewQuotation/<?php echo e($key); ?>">View Quote</a>
            
            <!--<a class="collapse-item" href="#SavedQuotes">Saved Quotes</a>-->
  ...
  <!--Select Light Weight Model-->
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
              <input type="submit" class="btn btn-success" id="car_submit" name="car_submit" value="Proceed">
          </form>
        </div>
      </div>
    </div>
