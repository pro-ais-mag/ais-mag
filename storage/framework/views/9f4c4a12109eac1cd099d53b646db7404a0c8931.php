...
<head>
  ...
  <meta name="author" content="<?php echo e(csrf_token()); ?>">
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="/exterior/<?php echo e($key); ?>">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span><b>Double Cab<b></span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/exterior/<?php echo e($key); ?>">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span><b>Double Cab Interior<b></span></a>
      </li> 
      <!--Go Back To Quote-->
      <li class="nav-item">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item double_cab_bumper" href="/doublecabfrontbumper/<?php echo e($key); ?>">Bumper</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/doublecabdoor/<?php echo e($key); ?>">Front Door</a>
            <a class="collapse-item" href="/doublecabreardoor/<?php echo e($key); ?>">Rear Door</a>
            <a class="collapse-item" href="/doublecabfrontsuspension/<?php echo e($key); ?>">Front Suspension</a>
            <a class="collapse-item" href="/doublecabrearsuspension/<?php echo e($key); ?>">Rear Suspension</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBakkie" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/doublecabrearbumper/<?php echo e($key); ?>">Rear Bumper</a>
          </div>
        </div>
      </li>  
      ...
      <li class="nav-item">
        ...
        <div id="collapseInnerFront" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/doublecabengine/<?php echo e($key); ?>">Engine</a>
            <a class="collapse-item" href="/doublecabtranmission/<?php echo e($key); ?>">Transmission</a>
            <a class="collapse-item" href="/doublecabAirConditioner/<?php echo e($key); ?>">Air Conditioner</a>
            <a class="collapse-item" href="/doublecabDashboard/<?php echo e($key); ?>">Dashboard</a>
          </div>
        </div>
      </li> 
      <!--End Nav-->
      ...
      <li class="nav-item">
        ...
        <div id="collapseInnerSide" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/doublecabFrontSeat/<?php echo e($key); ?>">Front Seat</a>
            <a class="collapse-item" href="/doublecabRearSeat/<?php echo e($key); ?>">Rear Seat</a>
       ...
       <li class="nav-item">
        ...
        <div id="collapseInnerRear" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/doublecabExhaust/<?php echo e($key); ?>">Exhaust</a>
            <a class="collapse-item" href="/doublecabFuel/<?php echo e($key); ?>">Fuel System</a>
          </div>
        </div>
      </li> 
      <!--End Nav-->
...
<br>
      ...
      <div id="content">
        ...
        <?php endif; ?>
          ...
          <?php echo $__env->yieldContent('vehicle'); ?>
                   ...
                   <!--
                           ...
                           <!-- Collapsable Card Quote -->
                                ...
                                <!-- Card Content - Collapse -->
                                            ...
                                            <table class="table table-bordered table-sm" id="quoteData" width="80%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                <th>Oper</th>
                                                <th>Description</th>
                                            ...
                                            <button class="btn btn-primary editQuote btn-sm" data-id="<?php echo e($quote_infos->id); ?>" data-oper="<?php echo e($quote_infos->Oper); ?>" data-desc="<?php echo e($quote_infos->Description); ?>" data-markup="<?php echo e($quote_infos->MarkUp); ?>" data-bett="<?php echo e(number_format($quote_infos->Betterment,2)); ?>" data-qty="<?php echo e(number_format($quote_infos->Quantity,2)); ?>" data-part="<?php echo e(number_format($quote_infos->Part,2)); ?>" data-labour="<?php echo e(number_format($quote_infos->Labour,2)); ?>" data-paint="<?php echo e(number_format($quote_infos->Paint,2)); ?>" data-strip="<?php echo e(number_format($quote_infos->Strip,2)); ?>" data-frame="<?php echo e(number_format($quote_infos->Frame,2)); ?>" data-outwork="<?php echo e(number_format($quote_infos->Misc,2)); ?>">
                                ...
                                <div class="row">
                                <!--<a class="btn btn-warning" href="/printQuote/<?php echo e($key); ?>"  target="_blank">Print Quote</a>--> 
                                
                                <button class="btn btn-warning dropdown-toggle" style="margin-left:15px;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-dropup-auto="false">
                                    Print Quote
                                  </button>
 ...
 <div class="modal fade" id="soperationsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
        <form class="form-horizontal" role="form" method="POST" action="/saveQuote">
        <?php echo e(csrf_field()); ?>
...
$(document).on('click','.edit_save',function(){
  ...
  //End Of Edit Quotes
        ...
        $('.doublecab_front_bumper').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });

        //AutoFill Front Door
        $('.doublecab_front_door').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });
        ...
        $('.doublecab_front_suspension').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });  

        //Autofill Rear Suspension
        $('.doublecab_rear_suspension').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });

        //Autofill Double Engine
        $('.doublecab_engine').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });

        //Autofill Transmission
        $('.doublecab_transmission').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });

        //Autofill Air Condition
        $('.doublecab_conditioner').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });

        //Autofill Front Seat
        $('.doublecab_front_seat').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });
        ...
        //Autofill Exhaust
        $('.doublecab_exhaust').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });

        //Autofill Fuel System
        $('.doublecab_fuel_system').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });
