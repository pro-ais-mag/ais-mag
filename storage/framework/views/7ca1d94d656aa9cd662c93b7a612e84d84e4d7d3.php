...
<body>
    ...
    <img src="img/letter_head.png">
        ...
        <table style="font-size:7">
            ...
            <?php 
                 $laborRate=$insurer->labour;
                 $paintRate=$insurer->Paint;
                 $stripRate=$insurer->Strip;
                 $frameRate=$insurer->Frame;
                 $paintSupply=$insurer->PaintSup;
                 $shopSupply=$insurer->ShopSup;
                 $covid=$covid_total;
                 $waste=$waste_total;
            ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <table style="font-size:7;width:520">
           ...
           <?php $__currentLoopData = $quotations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quotes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr style="font-size:6.5;"><td style="text-align:left;width:20;"><?php echo e($count); ?></td>
                ...
                <td style="text-align:right"><?php echo e(number_format($quotes->Paint,2)); ?></td>
                <td style="text-align:right"><?php echo e(number_format($quotes->Labour,2)); ?></td>
                <td style="text-align:right"><?php echo e(number_format($quotes->Strip,2)); ?></td>
                <td style="text-align:right"><?php echo e(number_format($quotes->Frame,2)); ?></td>
                <td style="text-align:right"><?php echo e(number_format($quotes->Misc,2)); ?></td>
            </tr>
            <?php $count++;$parts=($quotes->Quantity*($quotes->Part +($quotes->Part * ($quotes->Percent/100))))+$parts;?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <tfoot><tr><td></td></tr><tr><td style="text-align:left;font-size:7;width:26;"><b>Total</b></td>
                ...
                <td style="text-align:right;font-size:6"><b><?php echo e(number_format($paint_total * $paintRate,2)); ?></b></td>
                <td style="text-align:right;font-size:6"><b><?php echo e(number_format($labour_total * $laborRate,2)); ?></b></td>
                <td style="text-align:right;font-size:6"><b><?php echo e(number_format($strip_total * $stripRate,2)); ?></b></td>
                <td style="text-align:right;font-size:6"><b><?php echo e(number_format($frame_total * $frameRate,2)); ?></b></td>
                <td style="text-align:right;font-size:6"><b><?php echo e(number_format($outwork_total,2)); ?></b></td>
            </tr></tfoot>  
                    ...
                    <td style="width:150">
                        <table>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right;width:60;"><b>R <?php echo e(number_format(($labour_total*$laborRate)+($paint_total*$paintRate)+($strip_total*$stripRate)+($frame_total*$frameRate)+($parts*($shopSupply/100))+$outwork_total+($paint_total*$paintRate*($paintSupply/100))+$parts+$waste+$covid,2)); ?></b></td>
                            </tr>
                            
                            <tr>
                                <td style="width:140">VAT @ 15% </td>
                                <td style="text-align:right;width:60">R <?php echo e(number_format(((($labour_total*$laborRate)+($paint_total*$paintRate)+($strip_total*$stripRate)+($frame_total*$frameRate)+($parts*($shopSupply/100))+$outwork_total+($paint_total*$paintRate*($paintSupply/100)) +$parts)*0.15),2)); ?></td>
                            </tr>
                            <tr>
