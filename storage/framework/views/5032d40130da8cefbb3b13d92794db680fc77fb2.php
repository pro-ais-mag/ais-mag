                    ...
                    <!--Client Details-->
                        ...
                        <input type="hidden" id="ref" name="ref" value="<?php echo e($key); ?>">
                            ...
                            <div class="input-group sm">
                                ...
                                <option value="<?php echo e($client->branch); ?>"><?php echo e($client->branch); ?></option>
                    ...
                    <div class="card shadow mb-3 col-3" style="margin-left:5px;">
                        ...
                        <div class="input-group sm">
                                <div class="input-group-prepend">
                                    ...
                                    <select name="insuror_edit" id="insuror_edit" class="form-control form-control-sm" style="margin-bottom:10px;" value="<?php echo e($client->Inserer); ?>">
                        ...
                        <div class="input-group sm">
                                ...
                                <input type="text" name="contact_number_edit" id="contact_number_edit" value="<?php echo e($client->ins_contact); ?>"class="form-control form-control-sm" style="margin-bottom:10px;" disabled>
                        </div>
                        <div class="input-group sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text sm" id="basic-addon1" style="height:32px;">I. Email</span>
                                </div>    
                                <input type="text" name="insurance_email_edit" id="insurance_email_edit" value="<?php echo e($client->ins_email); ?>" class="form-control form-control-sm" style="margin-bottom:10px;" disabled>
                        </div>
                        <div class="input-group sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text sm" id="basic-addon1" style="height:32px;">Claim No.</span>
                                </div>        
                                <input type="text" name="claim_number_edit" id="claim_number_edit" value="<?php echo e($client->ins_claim); ?>" class="form-control form-control-sm" style="margin-bottom:10px;" disabled>
                        </div>
                        <div class="input-group sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text sm" id="basic-addon1" style="height:32px;">Clerk Ref.</span>
                                </div>        
                                <input type="text" name="clerk_ref_edit" id="clerk_ref_edit" value="<?php echo e($client->ClerkName); ?>"class="form-control form-control-sm"  style="margin-bottom:10px;" disabled>
                        </div>  
                        <div class="input-group sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text sm" id="basic-addon1" style="height:32px;">Assessor</span>
                                </div>      
                                <select name="assessor_edit" id="assessor_edit" class="form-control form-control-sm" style="margin-bottom:10px;" disabled>
                        ...
                        <div class="input-group sm">
                                ...
                                <input type="email" name="assessor_email_edit" id="assessor_email_edit" value="<?php echo e($client->Assessor_Email); ?>" class="form-control form-control-sm" style="margin-bottom:10px;" disabled>
                        </div>        
                        <div class="input-group sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text sm" id="basic-addon1" style="height:32px;">A.Contact</span>
                                </div>
                                <input type="text" name="assessor_no_edit" id="assessor_no_edit" value="<?php echo e($client->Assessor_Cell); ?>" class="form-control form-control-sm" style="margin-bottom:10px;" disabled>
                        </div>
                        <div class="input-group sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text sm" id="basic-addon1" style="height:32px;">A.Company</span>
                                </div>        
                                <input type="text" name="assessor_company_edit" id="assessor_company_edit" value="<?php echo e($client->Assessor_comp); ?>" class="form-control form-control-sm" style="margin-bottom:10px;" disabled>
                        </div>        
                        </div>
                    </div>
                    <!--End Insurance-->
                        ...
                        <div class="card shadow mb-3 col-2" style="margin-left:5px;">
                            ...
                            <h6 class="m-0 font-weight-bold text-primary">Tow Details.</h6>
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    <select name="towed_by_edit" id="towed_by_edit" class="form-control form-control-sm" style="margin-bottom:10px;" disabled>
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" name="tow_contact_number_edit" id="tow_contact_number_edit" value="<?php echo e($client->tow_tel); ?>" class="form-control form-control-sm" style="margin-bottom:10px;" disabled>
                                </div>    
                                <div class="input-group sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text sm" id="basic-addon1" style="height:32px;">Email</span>
                                </div>
                                    <input type="email" name="tow_email_edit" id="tow_email_edit" value="<?php echo e($client->tow_email); ?>" class="form-control form-control-sm" style="margin-bottom:10px;" disabled>
                                </div>    
                                <div class="input-group sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text sm" id="basic-addon1" style="height:32px;">Fee</span>
                                </div>    
                                    <input type="text" name="tow_fee_edit" id="tow_fee_edit" value="<?php echo e($client->towing_fee1); ?>" class="form-control form-control-sm" style="margin-bottom:10px;" disabled>
                                </div>
                                <div class="input-group sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text sm" id="basic-addon1" style="height:32px;">File Status</span>
                                </div>    
                                    <select name="towed_status_edit" id="towed_status_edit" class="form-control form-control-sm" style="margin-bottom:10px;" disabled>
