...
<body>
    ...
    <img src="img/letter_head.png">
        <p style="text-align:center;font-size:8"><b>AUTHORIZED QUOTE</b><br> <span style="font-size:7">Date: <?php echo e(date('Y-m-d')); ?></span></p>
        <table style="font-size:7">
            ...
            <?php $laborRate=$insurer->labour; $paintRate=$insurer->Paint;$stripRate=$insurer->Strip;$frameRate=$insurer->Frame;$paintSupply=$insurer->PaintSup;$shopSupply=$insurer->ShopSup;$waste=$waste_total;?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <table style="font-size:7;width:520">
           ...
           <?php $__currentLoopData = $quotations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quotes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php $count++;$overallPaint=$overallPaint+($quotes->Paint * $paintRate);$overalLabour=$overalLabour+($quotes->Labour * $laborRate);$overallStrip=$overallStrip+($quotes->Strip * $stripRate); $overallOutwork+=$quotes->Misc;$overallFrame+=$quotes->Frame * $frameRate;$parts=($quotes->Quantity*($quotes->Part +($quotes->Part * ($quotes->Percent/100))))+$parts;?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
