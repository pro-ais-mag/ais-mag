...
<div class="tab-pane fade show" id="list-security-photos" role="tabpanel" aria-labelledby="list-home-list">
    ...
    <h5 class="text-primary" style="text-align:center;"><b><?php echo e($title); ?></b></h5>
    <div class="row">
        <div>
        <form action="<?php echo e($action); ?>" class="form-control-sm" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
    ...
    <div class="row">
        ...
        <?php if($process_photos->count()): ?>
        <?php $__currentLoopData = $process_photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            ?>
             <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                <a class="thumbnail fancybox" rel="ligthbox" href="<?php echo e($file_name); ?>" target=z>
                ...
                <input type="checkbox" class="checkitem" data-photo_id="<?php echo e($image->id); ?>" data-photo_path="<?php echo e($file_name); ?>" data-photo_name="<?php echo e($photo); ?>" data-photo_real_path="<?php echo e($real_path); ?>" />
