...
<body>
        ...
        <table style="font-size:8">
            <tr>
                ...
                <td style="width:250">: <?php echo e($supname); ?></td>
                <td><b>Date</b></td>
                <td>: <?php echo e($date); ?></td>
            </tr>
            <tr>
                <td><b>Supplier Email</b></td>
                <td style="width:250">: <?php echo e($supemail); ?></td>
                <td><b>Credit Note No.</b></td>
                <td>: <?php echo e($rfcno); ?></td>
            </tr>
            <tr>
                <td><b>Order Number</b></td>
                <td style="width:250">: <?php echo e($ordnum); ?></td>
                <td><b>Reference</b></td>
                <td>: <?php echo e($key); ?></td>
            </tr>
            <tr>
                <td><b>Done By</b></td>
                <td style="width:250">: <?php echo e($user); ?></td>
                <td><b></b></td>
                <td></td>
            </tr>
        </table>
        ...
        <table style="font-size:10;font-family:courier" border="1">
            ...
            <tr>
                <td style="width:70"><?php echo e($qty); ?></td>
                <td style="width:100"><?php echo e($partNo); ?></td>
                <td style="width:90"><?php echo e($des); ?></td>
                <td style="width:115"><?php echo e($Invceno); ?></td>
                <td style="width:100"><?php echo e($price); ?></td>
                <td style="width:185"><?php echo e($comm); ?></td>
            </tr>
        </table>
