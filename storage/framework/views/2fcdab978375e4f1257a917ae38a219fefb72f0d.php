...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav navbar-nav-dark bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="/user">
          ...
          <span><?php echo e($position); ?> Dash</span></a>
      </li>
     ...
     echo' <hr class="sidebar-divider">
        ...
        <div id="collapseQuotaions" class="collapse" aria-labelledby="headingQuotaions" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/allquotes">All Quotes</a>
            <a class="collapse-item" href="/authorized">Authorized</a>
            
            <a class="collapse-item" href="/printSalvage" target="_blank">Print Salvage</a>
            <a class="collapse-item" href="http://192.168.0.185:8080/MagWorkInProgress/" target="_blank">Edit Salvage List</a>
...
<li class="nav-item">
        ...
        <div id="collapseLineManager" class="collapse" aria-labelledby="headingLineManager" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <!--<a class="collapse-item" href="/line-manager-timesheet">General Work</a>-->
...
<li class="nav-item">
        ...
        <div id="collapseCreditors" class="collapse" aria-labelledby="headingCosting" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
...
echo '<hr class="sidebar-divider">
<li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseCosting" aria-expanded="true" aria-controls="collapseUtilities">
          <i class="fas fa-fw fa-shopping-cart"></i>
          <span>Parts Dash</span>
        </a>
        <div id="collapseCosting" class="collapse" aria-labelledby="headingCosting" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
    ...
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content"  style="font-size:10px;">
        <div class="modal-header bg-info">
          ...
          <a href="#" class="btn btn-secondary btn-sm final_photos" data-id="<?php echo e($key); ?>" data-category="ADDITIONAL" title="Send Images" style="margin-left:10px;"><span class="fa fa-image"></span> Photos</a>
        ...
        <div style="float:left; margin-right:10px;">
            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-dismiss="modal" data-target="#final_stage_additional_grouped" >Back</button>
            
          </div>
          <form method="POST" action="/print-notification/<?php echo e($key); ?>" target="_blank"> 
                      <?php echo csrf_field(); ?>
...
<div class="modal fade" id="final_stage_additional_grouped" >
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content"  style="font-size:10px;">
        <div class="modal-header bg-success">
          <h5 class="modal-title" id="exampleModalLabel" style="color:white;text-align:center;">Track ID: <?php echo e($key); ?> </h5>

          <!--
          <a href="#" class="btn btn-success btn-sm" title="Create New Additional"><span class="fa fa-plus"></span></a> 
          -->
        ...
        <div class="modal-header bg-danger">
          ...
          <div class="btn-group">
            ...
            <div class="dropdown-menu animated--fade-in" aria-labelledby="dropdownMenuButton">
              ...
              <a class="dropdown-item" href="/print-final-additonal/<?php echo e($key); ?>" target="_blank">No Water Mark</a>
              <a class="dropdown-item" href="/print-final-additonal-all-figure/<?php echo e($key); ?>?value=all-figure" target="_blank">All in Figure</a>
              <a class="dropdown-item" href="/print-final-additonal-no-extra/<?php echo e($key); ?>?value=no-extra" target="_blank">No Extra</a>
              <a class="dropdown-item" href="/print-time-sheet/<?php echo e($key); ?>" target="_blank">Time Sheet</a>
...
<div class="modal fade" id="final_stage_email" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content sm">
        ...
        <form method="POST" action="/print-and-email-notification/<?php echo e($key); ?>" target="_blank">
          <?php echo csrf_field(); ?>
      ...
      <div class="modal-content sm">
        ...
        <div class="modal-body" style="font-size:10px;">
          ...
          <label for="landing_amount">Part Amount:</label>
            <input type="number" id="stores_landing_amount" step="any" name="stores_landing_amount" class="form-control form-control-sm" > 
          </div>
        ...
        <table class="table table-sm" style="font-size:10px;">
          ...
          <form method="GET" action="/print-parts-credit" target="_blank">
              ...
              <tr>
                  ...
                  <td>
                  <div class="btn-group">
                    <!-- # PRINT PDF AND SAVE IN THE DATABASE -->
...
<div class="modal fade" id="plus_sign_modal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content"  style="font-size:10px;">
        <div class="modal-header bg-info">
          <h6 class="modal-title" id="exampleModalLabel" style="color:white;text-align:center;">Create New Additional.</h6>
...
<td>
    ...
    <select id="oper" name="oper" class="form-control" style="font-size:10px;">
    </select>
...
<td><input type="text" name="percent" id="percent" value="0" style="width:50px;font-size:10px;" class="form-control form-control-sm"></td>
<td><input type="text" name="bett" id="bett" value="0"  style="width:50px;font-size:10px;" class="form-control form-control-sm"></td>
<td><input type="text" name="qty" id="qty" value="1" style="width:50px;font-size:10px;" class="form-control form-control-sm"></td>
<td><input type="text" name="part" id="part" value="0" style="width:50px;font-size:10px;" class="form-control form-control-sm"></td>
<td><input type="text" name="labor" id="labor" value="0" style="width:50px;font-size:10px;" class="form-control form-control-sm"></td>
<td><input type="text" name="paint" id="paint" value="0" style="width:50px;font-size:10px;" class="form-control form-control-sm"></td>
<td><input type="text" name="r_r" id="r_r" value="0" style="width:50px;font-size:10px;" class="form-control form-control-sm"></td>
<td><input type="text" name="frame" id="frame" value="0" style="width:50px;font-size:10px;" class="form-control form-control-sm"></td>
<td><input type="text" name="in_house" id="in_house" value="0" style="width:50px;font-size:10px;" class="form-control form-control-sm"></td>
<td><input type="text" name="outwork" id="outwork" value="0" style="width:50px;font-size:10px;" class="form-control form-control-sm"></td>
<td>
...
<div class="modal fade" id="create_customercare_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
    <div class="modal-dialog" role="document">
      <div class="modal-content"  style="width:600px;font-size:10px;">
        ...
        <form action="/customer-care-create-note" method="GET">
...
<!-- Upload Document Customer Care -->
<div class="modal fade" id="upload_docs_customercare_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
    <div class="modal-dialog" role="document">
      <div class="modal-content"  style="width:600px;font-size:10px;">
        <div class="modal-header bg-success">
          <h5 class="modal-title" id="exampleModalLabel" style="color:white;">Upload Document Customer Care.</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
          </button>
        </div>
        <form action="/customer-care-save-document" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="modal-body" style="font-size:10px;">
              <div class="row">
                  <div class="form-group col-6">
                    <label for="customer_care_doc_type">Document Desc.</label>
                    <select id="customer_care_doc_type" name="customer_care_doc_type" class="form-control form-control-sm"></select>
                  </div>
                  <div class="form-group col-6">
                    <label for="image">Select File:</label>
                    <input type="file" class="form-control-sm form-file" id="image" name="image">
                  </div>  
              </div>
        </div>
        <div class="modal-footer">
...
<div class="modal fade" id="OrderingOtpModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" >
    <div class="modal-dialog" role="document">
      <div class="modal-content"  style="width:600px;font-size:10px;">
        ...
        <div class="modal-footer">
          <button class="btn btn-secondary btn-sm" type="button" data-dismiss="modal">Cancel</button>
          <input type="submit" class="btn btn-success btn-sm" value="Proceed">
        </div>
        </form>
      </div>
    </div>
...
$(document).on('click','.create_supplier_order',function(){
  $('#CreateOrderNew').modal('show');
});
...
//Create New Insurer Modal
$(document).on('click','.create_broker',function(){
  $('#create_new_insurer').modal('show');
});
...
//Customer Care Save Notes
$(document).on('click','.customer_care_save_note',function(){
  $('#customer_id').val($(this).data('id'));
  $('#create_customercare_modal').modal('show');
});

//Customer Care Get All Documents And Show Modal
$(document).on('click','.customer_care_save_document',function(){
            var html="";
           var select="<option value=''>--Select Document Type--</option>";
           $.ajax({
            type:'GET',
            url: '/customer-care-doc-type',
            success:function(data){
               for (var i = 0; i < data.length; i++) {
              html='<option value="' +data[i]+'">'+ data[i]+'</option>';
                select=select+html;   
         }
              $('#customer_care_doc_type').html(select);
                         
            }  
            });
  $('#doc_id').val($(this).data('id'));
  $('#upload_docs_customercare_modal').modal('show');
});
  ...
  //WIP Print Report
    $(document).on('click','',function(){
      var user = $('#wip_user').val();
      var date1=$('#wip_from').val();
      var date2= $('#wip_to').val();
      $.ajax({
        type:'GET',
        url:'',
        data:{
...
//Store RFC
$(document).on('click','.stores_rfc',function(){
  $('#rfcsDocumentModal').modal('show');
});
...
//On button click
function showChecked(isChecked){
  $('#auth_check').modal('show');
}
...
//Autofill Credit Description Quantity
$('#credit_description').change(function() {

            var name=$("#credit_description").val();
            var id=$('#credit_id').val();

           $.ajax({
            type:'GET',
            url: '/pre-costing-get-part-quantity',
            data: {'name':name,'id':id},
            success:function(data){
              $('#credit_quan').val(data[0]);
              $('#credit_order_id').val(data[1]);  
              $("#print_part_credit").attr("href",'/print-stores-rfc/'+data[1]+'');
            }  
            });
    ...
    //Final Stage Edit VAT Amount    
    function updateVat(obj_id){
		var id  = obj_id;
		var vat = $('#vatVal').html();
		$.ajax({
		type   :'POST',
      ...
      '_token':"<?php echo e(csrf_token()); ?>",
        ...
        //Final Stage Change Additional Operation
        function funkThissOper(id){
        ...
        function changeThissMarkUp_(idz){
          var dd = idz.substring(idz.indexOf("_"));
            var d = $("#EditAddQtsMarkUpNewTds1" + dd).val();
            /*
            if (parseInt($("#EditAddQtsMarkUpNewTds1" + dd).val()) > 0) {
                $("#EditAddQtsMarkUpNewTds" + dd).val(0);
                $("#EditAddQtsMarkUpNewTds" + dd).trigger('change');
            }
            */
            ...
            //alert('Mark Up Outwork');
            location.reload(true);
        }

        

        //Final Stage Outwork Betterment Change
...
var assessor_company  = $("#assessor_company").val();
 ...
 $.ajax({
      ...
      method:"post",
      data:{'_token':"<?php echo e(csrf_token()); ?>",ref : key_ref,
       name_edit : name,
