...
<br>
              <div id="mySidepanel" class="sidepanel">
                ...
                <?php if($client_photos->count()): ?>
                    <?php $__currentLoopData = $client_photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image_track): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                            <a class="thumbnail fancybox" rel="ligthbox" href="/images/mag_photos/<?php echo e($image_track->Key_Ref); ?>/<?php echo e($image_track->picture_name); ?>" target="_blank">
                                <img class="img-fluid img-thumbnail" src="/images/mag_photos/<?php echo e($image_track->Key_Ref); ?>/<?php echo e($image_track->picture_name); ?>" target="_blank">
                            ...
                            <div class="row">
                              <div class="btn-group">
                                <a class="btn btn-danger btn-sm" href="/remove-track-photo/<?php echo e($image_track->id); ?>" title="Delete Image" style="font-size:12px;color:white;margin-left:40px;">Remove</a>       
            ...
            <div class="btn-group">
              <!--<a href="<?php echo e(url()->previous()); ?>" class="btn btn-danger btn-sm" title="Previous Page">Back</a>-->
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <table class="table-sm table-bordered" style="font-size:10px;">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <select id="opa" name="opa" class="form-control" style="font-size:12px;" required>
                          ...
                          <td><input type="text" name="mark" id="mark" style="width:50px;font-size:12px;" class="form-control" required></td>
                          <td><input type="text" name="bett" id="bett"  style="width:50px;font-size:12px;" class="form-control" required></td>
                          <td><input type="number" name="qty" id="qty" style="width:50px;font-size:12px;" class="form-control" required></td>
                          <td><input type="text" name="part" id="part" style="width:100px;font-size:12px;" class="form-control" required></td>
                          <td><input type="text" name="labor" id="labor" style="width:50px;font-size:12px;" class="form-control" required></td>
                          <td><input type="text" name="paint" id="paint" style="width:50px;font-size:12px;" class="form-control" required></td>
                          <td><input type="text" name="strip" id="strip" style="width:50px;font-size:12px;" class="form-control" required></td>
                          <td><input type="text" name="frame" id="frame" style="width:50px;font-size:12px;" class="form-control" required></td>
                          <td><input type="text" name="outwork" id="outwork" style="width:50px;font-size:12px;" class="form-control" required></td>
                ...
                <br>
                <table class="table table-sm" style="font-size:10px;" id="workin" name="workin">
            ...
            </div></br><a href="#" data-id="<?php echo e($key); ?>" class="btn btn-primary btn-sm"><span class="fa fa-copy">Copy Quote</span></a>
