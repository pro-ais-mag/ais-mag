...
<li class="nav-item">
        ...
        <div id="collapseCosting" class="collapse" aria-labelledby="headingCosting" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
           ...
           <a class="collapse-item" href="#Ordering">Ordering</a>
            <a class="collapse-item" href="#AdditionalCosting">Additonal Costing</a>
...
$(document).on('click','.customer_care_save_document',function(){
  ...
  $('#customer_care_documents').modal('show');
});
...
//Save Inventory Consumerables
$(document).on('click','.save_inventory_all',function(){
...
//Pasted From Admin Dashboard
    ...
    $(document).on('click','.edit-modal-ais',function(){
      ...
      $('#ais_password_edit').val($(this).data('password')); 
...
//2020-07-30  -please change and update the administrator
 ...
 $(document).ready(function() {
  ...
  function changeThisOper(idz) {
            ...
            if ($("#EditAddQtsOperNewTd" + dd).get(0).selectedIndex === 0) {
                ...
                $.ajax({
                    url: '../models/updateFinalOper.php',
                    data: {
                        id: id,
                        d: d
                    },
