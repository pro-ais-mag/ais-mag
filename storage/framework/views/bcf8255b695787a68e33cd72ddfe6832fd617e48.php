...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="/singlecab/<?php echo e($key); ?>">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span><b>Single Cab<b></span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/singlecabInterior/<?php echo e($key); ?>">
          <i class="fas fa-fw fa-tachometer-alt"></i>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item double_cab_bumper" href="/singlecabFrontBumper/<?php echo e($key); ?>">Bumper</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/singlecabdoor/<?php echo e($key); ?>">Front Door</a>
            <a class="collapse-item" href="/singlecabFrontSuspension/<?php echo e($key); ?>">Front Suspension</a>
            <a class="collapse-item" href="/singlecabrearsuspension/<?php echo e($key); ?>">Rear Suspension</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseInnerFront" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/singlecabEngine/<?php echo e($key); ?>">Engine</a>
            <a class="collapse-item" href="/singlecabtransmission/<?php echo e($key); ?>">Transmission</a>
            <a class="collapse-item" href="/singlecabAirConditioner/<?php echo e($key); ?>">Air Conditioner</a>
            <a class="collapse-item" href="/singlecabDashboard/<?php echo e($key); ?>">Dashboard</a>
          </div>
        </div>
      </li> 
      <!--End Nav-->
      ...
      <li class="nav-item">
        ...
        <div id="collapseInnerSide" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/singlecabFrontSeat/<?php echo e($key); ?>">Front Seat</a>
       ...
       <li class="nav-item">
        ...
        <div id="collapseInnerRear" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/singlecabExhaust/<?php echo e($key); ?>">Exhaust</a>
            <a class="collapse-item" href="/singlecabFuel/<?php echo e($key); ?>">Fuel System</a>
          </div>
        </div>
      </li> 
      <!--End Nav-->
...
<br>
      ...
      <div id="content">
        ...
        <?php endif; ?>
          ...
          <?php echo $__env->yieldContent('singlecab'); ?>
                   ...
                   <!--
                           ...
                           <!-- Collapsable Card Quote -->
                                ...
                                <!-- Card Content - Collapse -->
                                            ...
                                            <button class="btn btn-primary editQuote" data-id="<?php echo e($quote_infos->id); ?>" data-oper="<?php echo e($quote_infos->Oper); ?>" data-desc="<?php echo e($quote_infos->Description); ?>" data-markup="<?php echo e($quote_infos->MarkUp); ?>" data-bett="<?php echo e(number_format($quote_infos->Betterment,2)); ?>" data-qty="<?php echo e(number_format($quote_infos->Quantity,2)); ?>" data-part="<?php echo e(number_format($quote_infos->Part,2)); ?>" data-labour="<?php echo e(number_format($quote_infos->Labour,2)); ?>" data-paint="<?php echo e(number_format($quote_infos->Paint,2)); ?>" data-strip="<?php echo e(number_format($quote_infos->Strip,2)); ?>" data-frame="<?php echo e(number_format($quote_infos->Frame,2)); ?>" data-outwork="<?php echo e(number_format($quote_infos->Misc,2)); ?>">
