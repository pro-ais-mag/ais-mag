...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="/2door/<?php echo e($key); ?>">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span><b>2 Door Exterior<b></span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/2doorInterior/<?php echo e($key); ?>">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span><b>2 Door Interior<b></span></a>
      </li>  
      <!--Go Back To Quote-->
      <li class="nav-item">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item double_cab_bumper" href="/2doorFrontBumper/<?php echo e($key); ?>">Bumper</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/2doorFrontDoor/<?php echo e($key); ?>">Front Door</a>
            <a class="collapse-item" href="/2doorFrontSuspension/<?php echo e($key); ?>">Front Suspension</a>
            <a class="collapse-item" href="/2doorRearSuspension/<?php echo e($key); ?>">Rear Suspension</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBakkie" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/2doorRearBumper/<?php echo e($key); ?>">Rear Bumper</a>
          </div>
        </div>
      </li>  
      ...
      <li class="nav-item">
        ...
        <div id="collapseInnerFront" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/2doorEngine/<?php echo e($key); ?>">Engine</a>
            <a class="collapse-item" href="/2doorTransmission/<?php echo e($key); ?>">Transmission</a>
            <a class="collapse-item" href="/2doorAirConditioner/<?php echo e($key); ?>">Air Conditioner</a>
            <a class="collapse-item" href="/2doorDashboard/<?php echo e($key); ?>">Dashboard</a>
          </div>
        </div>
      </li> 
      <!--End Nav-->
      ...
      <li class="nav-item">
        ...
        <div id="collapseInnerSide" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/2doorFrontSeat/<?php echo e($key); ?>">Front Seat</a>
            <a class="collapse-item" href="/2doorRearSeat/<?php echo e($key); ?>">Rear Seat</a>
       ...
       <li class="nav-item">
        ...
        <div id="collapseInnerRear" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/2doorExhaust/<?php echo e($key); ?>">Exhaust</a>
            <a class="collapse-item" href="/2doorFuel/<?php echo e($key); ?>">Fuel System</a>
          </div>
        </div>
      </li> 
      <!--End Nav-->
...
<div>
    <button title="NEW" class="show-modal btn btn-secondary"style="margin-top:5px;">N</button>
...
<br>
      ...
      <div id="content">
        ...
        <?php endif; ?>
          ...
          <?php echo $__env->yieldContent('2door'); ?>
                   ...
                   <!--
                           ...
                           <!-- Collapsable Card Quote -->
                                ...
                                <!-- Card Content - Collapse -->
                                            ...
                                            <button class="btn btn-primary editQuote" data-id="<?php echo e($quote_infos->id); ?>" data-oper="<?php echo e($quote_infos->Oper); ?>" data-desc="<?php echo e($quote_infos->Description); ?>" data-markup="<?php echo e($quote_infos->MarkUp); ?>" data-bett="<?php echo e($quote_infos->Betterment); ?>" data-qty="<?php echo e($quote_infos->Quantity); ?>" data-part="<?php echo e($quote_infos->Part); ?>" data-labour="<?php echo e($quote_infos->Labour); ?>" data-paint="<?php echo e($quote_infos->Paint); ?>" data-strip="<?php echo e($quote_infos->Strip); ?>" data-frame="<?php echo e($quote_infos->Frame); ?>" data-outwork="<?php echo e($quote_infos->Misc); ?>">
                                                <span class="fa fa-edit"></span></button>    
                                                
                                                <a class=" btn btn-danger" href="/deleteQuote/<?php echo e($quote_infos->id); ?>" style="margin-left:5px;" data-id="<?php echo e($quote_infos->id); ?>" data-oper="<?php echo e($quote_infos->Oper); ?>" data-desc="<?php echo e($quote_infos->Description); ?>" data-markup="<?php echo e($quote_infos->MarkUp); ?>" data-bett="<?php echo e($quote_infos->Betterment); ?>" data-qty="<?php echo e($quote_infos->Quantity); ?>" data-part="<?php echo e($quote_infos->Part); ?>" data-labour="<?php echo e($quote_infos->Labour); ?>" data-paint="<?php echo e($quote_infos->Paint); ?>" data-strip="<?php echo e($quote_infos->Strip); ?>" data-frame="<?php echo e($quote_infos->Frame); ?>" data-outwork="<?php echo e($quote_infos->Misc); ?>">
...
$(document).on('click','.edit_save',function(){
  ...
  //End Of Edit Quotes
        ...
        $('.door3_frontbumper').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });

        //AutoFill Front Door
        $('.door3_front_door').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });

        //AutoFill Rear Door
        $('.door3_rear_door').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });

        //AutoFill Front Suspension
        $('.door3_front_suspension').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });  

        //Autofill Rear Suspension
        $('.door3_rear_suspension').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });

        //AutoFill Rear Bumper
        $('.door3_rearbumper').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });


        //Autofill Double Engine
        $('.door3_engine').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });

        //Autofill Transmission
        $('.door3_transmission').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });

        //Autofill Air Condition
        $('.door3_airconditioner').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });

        //Autofill Dashboard
        $('.door3_dashboard').on('click',function(e){
          $('#InputDesc').val($(this).data('picture_id'));
        });

        //Autofill Front Seat
        $('.door3_front_seat').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });

        //Autofill Rear Seat
        $('.door3_rear_seat').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });

        //Autofill Exhaust
        $('.door3_exhaust').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });

        //Autofill Fuel System
        $('.door3_fuel').on('click',function(e){
          $("#InputDesc").val($(this).data('picture_id'));
        });
