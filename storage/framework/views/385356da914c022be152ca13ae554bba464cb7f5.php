                            ...
                            <div class="tab-content" id="nav-tabContent">
                                            ...
                                            ?>
                                                <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                                                    <a class="thumbnail fancybox" rel="ligthbox" href="<?php echo e($file_name); ?>" target='_blank'>
                                                        <img class="img-fluid img-thumbnail" alt="" src="<?php echo e($file_name); ?>" target='_blank'>
                                ...
                                <div class="tab-pane fade show" id="list-wip-photos" role="tabpanel" aria-labelledby="list-home-list">
                                        ...
                                        <div class="row">
                                            ...
                                            <?php $__currentLoopData = $wip_photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php
                                            $file_name="";  
                                                ...
                                                <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                                                    <a class="thumbnail fancybox" rel="ligthbox" href="<?php echo e($file_name); ?>" target="_blank">
                                                        <img class="img-fluid img-thumbnail" alt="" src="<?php echo e($file_name); ?>" target='_blank'>
                                                        <div class='text-center'>
                                                            <small class='text-muted'>Note:<?php echo e($photo->picture_comment); ?></small>
                                                        </div> <!-- text-center / end -->
                                                    </a>
                                                    <a class="btn btn-danger" href="/line-manager-delete/<?php echo e($photo->id); ?>"><span class="fa fa-trash" ></span></a>
                                ...
                                <h5 class="text-primary" style="text-align:center;"><b>Additional Photos</b></h5>
                                        ...
                                        <div class="row">
                                            <div class="row text-center text-lg-left">
                                            <?php if($additional_photos->count()>0): ?>
                                            <?php $__currentLoopData = $additional_photos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                                                    <a class="thumbnail fancybox" rel="ligthbox" href="<?php echo e($file_name); ?>" target="_blank">
                                                        <img class="img-fluid img-thumbnail" alt="" src="<?php echo e($file_name); ?>" target="_blank">
                                                        <div class='text-center'>
                                                            <small class='text-muted'><?php echo e($photo->picture_comment); ?></small>
                                                        </div> <!-- text-center / end -->
                                                    </a>
                                                    <a class="btn btn-danger" href="/line-manager-delete/<?php echo e($photo->id); ?>"><span class="fa fa-trash" ></span></a>
                        ...
                        <input type="hidden" id="ref" name="ref" value="<?php echo e($key); ?>">
                            ...
                            <div class="input-group sm">
                                ...
                                <select name="branch_edit" id="branch_edit" class="form-control form-control-sm" style="margin-bottom:10px;font-size:10px;">
                                    <option style='color:olive' selected><?php echo e($client->branch); ?></option>
                    ...
                    <div class="card shadow mb-3 col-3" style="margin-left:2px;">
                        ...
                        <div class="input-group sm">
                                <div class="input-group-prepend">
                                    ...
                                    <input type="text" name="vin_number_edit" value="<?php echo e($client->Chasses_No); ?>" id="vin_number_edit" class="form-control form-control-sm" style="margin-bottom:10px;font-size:10px;">
                        </div>
                        <div class="input-group sm">
                                <div class="input-group-prepend">
                        ...
                        <div class="input-group sm">
                                ...
                                <input type="text" name="odometer_edit"  value="<?php echo e($client->KM); ?>" id="odometer_edit" class="form-control form-control-sm" style="margin-bottom:10px;font-size:10px;">
                        </div>
                        <div class="input-group sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text sm" id="basic-addon1" style="height:25px;font-size:10px;">Colour</span>
                                </div>        
                                <input type="text" name="colour_edit" id="colour_edit" value="<?php echo e($client->Colour); ?>" placeholder="Colour" class="form-control form-control-sm" value="<?php echo e($client->Colour); ?>" style="margin-bottom:10px;font-size:10px;"> 
                        </div>
                        <div class="input-group sm">
                                <div class="input-group-prepend">
                        ...
                        <div class="input-group sm">
                            <div class="input-group-prepend">
                                ...
                                <input type="date" name="booking_edit" value="<?php echo e($client->Date); ?>" id="booking_edit" placeholder="Booking Date" class="form-control form-control-sm" value="<?php echo e($client->booking_date); ?>" aria-describedby="basic-addon1" style="margin-bottom:10px;font-size:10px;">
                        </div>
                    ...
                    <div class="card shadow mb-3 col-3" style="margin-left:2px;">
                        ...
                        <div class="input-group sm">
                                <div class="input-group-prepend">
                                    ...
                                    <select name="insuror_edit" id="insuror_edit" class="form-control form-control-sm" style="margin-bottom:10px;font-size:10px;" value="<?php echo e($client->Inserer); ?>" readonly>
                                        <option style='color:olive' selected><?php echo e($client->Inserer); ?></option>
                        ...
                        <div class="input-group sm">
                                ...
                                <input type="text" name="contact_number_edit" id="contact_number_edit" value="<?php echo e($client->Phone); ?>"class="form-control form-control-sm" style="margin-bottom:10px;font-size:10px;" readonly>
                        </div>
                        <div class="input-group sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text sm" id="basic-addon1" style="height:25px;font-size:10px;">I. Email</span>
                                </div>    
                                <input type="text" name="insurance_email_edit" id="insurance_email_edit" value="<?php echo e($client->ins_email); ?>" class="form-control form-control-sm" style="margin-bottom:10px;font-size:10px;" readonly>
                        </div>
                        <div class="input-group sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text sm" id="basic-addon1" style="height:25px;font-size:10px;">Claim No.</span>
                                </div>        
                                <input type="text" name="claim_number_edit" id="claim_number_edit" value="<?php echo e($client->ins_claim); ?>" class="form-control form-control-sm" style="margin-bottom:10px;font-size:10px;" readonly>
                        </div>
                        <div class="input-group sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text sm" id="basic-addon1" style="height:25px;font-size:10px;">Clerk Ref.</span>
                                </div>        
                                <input type="text" name="clerk_ref_edit" id="clerk_ref_edit" value="<?php echo e($client->ClerkName); ?>"class="form-control form-control-sm"  style="margin-bottom:10px;font-size:10px;" readonly>
                        </div>  
                        <div class="input-group sm">
                                <div class="input-group-prepend">
                                ...
                                <select name="assessor_edit" id="assessor_edit" class="form-control form-control-sm" style="margin-bottom:10px;font-size:10px;" readonly>
                                    <option style='color:olive' selected><?php echo e($client->Assessor); ?></option>
                        ...
                        <div class="input-group sm">
                                ...
                                <input type="email" name="assessor_email_edit" id="assessor_email_edit" value="<?php echo e($client->Assessor_Email); ?>" class="form-control form-control-sm" style="margin-bottom:10px;font-size:10px;" readonly>
                        </div>        
                        <div class="input-group sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text sm" id="basic-addon1" style="height:25px;font-size:10px;">A.Contact</span>
                                </div>
                                <input type="text" name="assessor_no_edit" id="assessor_no_edit" value="<?php echo e($client->Assessor_Cell); ?>" class="form-control form-control-sm" style="margin-bottom:10px;font-size:10px;" readonly>
                        </div>
                        <div class="input-group sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text sm" id="basic-addon1" style="height:25px;font-size:10px;">A.Company</span>
                                </div>        
                                <input type="text" name="assessor_company_edit" id="assessor_company_edit" value="<?php echo e($client->Assessor_comp); ?>" class="form-control form-control-sm" style="margin-bottom:10px;font-size:10px;" readonly>
                        </div>        
                        </div>
