  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <hr class="sidebar-divider">
          ...
          <!-- Nav Item -  Body Side Menu -->
          <li class="nav-item">
          <a class="nav-link" href="/prebookings/<?php echo e($alert); ?>" >
            <i class="fas fa-fw fa-bell"></i>
            <span class="badge badge-danger badge-counter" style="margin-right:30px;">+<?php echo e($alert); ?></span><span>Pre-Bookings Alert</span>
          </a>
